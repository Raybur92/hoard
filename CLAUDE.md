...
**T1 done 2026-05-08** (migration + types). Schema + types are ready; every column stays null until T2/T3 populate them. **Next phase: T2 — PSN trophy fetcher.** Per hard rule 10, agent stops after T1 and waits for Andrea's go-ahead before T2.
