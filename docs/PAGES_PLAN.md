...
- **B-IGDB-3 (partial — foundation + Dashboard 3-tab; Library filter UI deferred to B-IGDB-3b)** IGDB-tag triple — **genres + themes + perspectives** — as three distinct filterable / browseable dimensions across the library. IGDB exposes all three as separate axes on every game:
