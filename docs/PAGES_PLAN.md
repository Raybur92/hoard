...
- **B-IGDB-3 (foundation + Dashboard 3-tab + Library chip strips; primary-lens routes + browse-by panel deferred to B-IGDB-3b2)** IGDB-tag triple — **genres + themes + perspectives** — as three distinct filterable / browseable dimensions across the library. IGDB exposes all three as separate axes on every game:
